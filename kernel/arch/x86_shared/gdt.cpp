...
SegmentDescriptor::SegmentDescriptor(uint32_t base, uint32_t length,
...
void GDT::Initialize() {
  ...
  GDT::s_descriptors[2] = SegmentDescriptor(
      0x00000000, 0xFFFFFFFF, SA_PRESENT | SA_WRITABLE | SA_SEGMENT | SA_RING0,
      SF_USE4KSIZE | SF_USE32BIT);
  GDT::s_descriptors[3] =
      SegmentDescriptor(0x00000000, 0xFFFFFFFF,
                        SA_PRESENT | SA_EXECUTABLE | SA_SEGMENT | SA_RING3,
                        SF_USE4KSIZE | SF_USE32BIT);
  GDT::s_descriptors[4] = SegmentDescriptor(
      0x00000000, 0xFFFFFFFF, SA_PRESENT | SA_WRITABLE | SA_SEGMENT | SA_RING3,
      SF_USE4KSIZE | SF_USE32BIT);
